...
export async function GET() {
  try {
    console.log('Fetching health data from Python API...');
    ...
    const pythonApiUrl = `${pythonBaseUrl}/health`;
    ...
    console.log('Successfully fetched health data from Python API');
    ...
    return NextResponse.json(
      {
        error: 'Failed to fetch health data from Python API',
