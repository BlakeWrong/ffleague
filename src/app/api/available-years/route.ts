...
export async function GET() {
  try {
    console.log('Fetching available years from Python API...');
    ...
    const pythonApiUrl = `${pythonBaseUrl}/available-years`;
    ...
    console.log('Successfully fetched available years from Python API');
    ...
    return NextResponse.json(
      {
        error: 'Failed to fetch available years from Python API',
